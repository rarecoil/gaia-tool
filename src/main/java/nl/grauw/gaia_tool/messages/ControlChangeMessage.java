...
public class ControlChangeMessage extends ShortMessage {
	...
	public enum Controller {
		...
		// effect controls
		EFFECTS_REVERB_CONTROL_1(12), EFFECTS_DELAY_CONTROL_1(13), EFFECTS_FLANGER_CONTROL_1(14), EFFECTS_DISTORTION_CONTROL_1(15),
		EFFECTS_REVERB_LEVEL(91), EFFECTS_DELAY_LEVEL(92), EFFECTS_FLANGER_LEVEL(93), EFFECTS_DISTORTION_LEVEL(94),
