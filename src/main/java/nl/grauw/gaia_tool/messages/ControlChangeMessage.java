...
public class ControlChangeMessage extends ShortMessage {
	...
	public enum Controller {
		...
		EXPRESSION(11), EFFECTS_CONTROL_1(15), LFO_RATE(16), LFO_FADE_TIME(19),
		LFO_PITCH_DEPTH(22), LFO_FILTER_DEPTH(25), LFO_AMP_DEPTH(28), BANK_SELECT_LSB(32),
		HOLD_1(64), OSC_PITCH(70), OSC_DETUNE(73), OSC_PULSE_WIDTH_MODULATION(76),
		OSC_PULSE_WIDTH(79), OSC_ENV_DEPTH(85), BEND_MODE(90), EFFECTS_LEVEL(94),
		FILTER_CUTOFF(102), FILTER_RESONANCE(105), FILTER_ENV_DEPTH(108),
		FILTER_KEY_FOLLOW(111), AMP_LEVEL(114),
