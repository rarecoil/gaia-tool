...
public class PatchCommonView extends JPanel implements AWTObserver{
	...
	private nl.grauw.gaia.tool.views.parameters.PatchCommonView patchCommonView;
	...
	private void initComponents() {
		...
		nl.grauw.gaia.tool.views.parameters.PatchCommonView pcv = getPatchCommonView();
		if (pcv != null)
			add(pcv);
	}
	...
	public nl.grauw.gaia.tool.views.parameters.PatchCommonView getPatchCommonView() {
		PatchCommon pc = patch.getCommon();
		if (patchCommonView == null || patchCommonView.getParameters() != pc) {
			if (pc != null)
				patchCommonView = new nl.grauw.gaia.tool.views.parameters.PatchCommonView(pc);
		}
