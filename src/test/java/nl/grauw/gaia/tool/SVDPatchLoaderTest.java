...
import nl.grauw.gaia.tool.SVDPatchLoader;
...
public class SVDPatchLoaderTest {
	...
	public void testLoadInputStream() throws IOException {
		...
		SVDPatchGroup loadedGroup = new SVDPatchGroup(new File("dummy.SVD"));
		SVDPatchLoader loader = new SVDPatchLoader(loadedGroup);
		loader.load(createSVDInputStream());
		
		assertTrue(original.isEqualTo(loadedGroup.getPatch(0, 0)));
		assertTrue(original.isEqualTo(loadedGroup.getPatch(7, 7)));
	}
